...
public class TestGameActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        gameController = new GameController(DataLoader.makeData());
    ...
    private void loadActions() {
        closeButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Toast.makeText(TestGameActivity.this, "Close clicked", Toast.LENGTH_SHORT).show();
            }
        });
...
//                Bu yerda tekshiriladi
        ...
        for (int i = 0; i < answerGroup.getChildCount(); i++) {
            ...
            answerButton.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    TestGameActivity.this.answerText = answerButton.getText().toString();
                }
            });
        }
